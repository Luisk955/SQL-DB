...
AS
	...
	SELECT U.ID ID,U.NAME NAME,U.LAST_NAME LAST_NAME, U.STATUS STATUS,U.PHONE_NUMBER PHONE_NUMBER,U.BIRTHDATE BIRTHDATE,U.BALANCE BALANCE,U.PAYPAL_USER PAYPAL_USER,U.EMAIL EMAIL,U.CREATION_DATE CREATION_DATE,R.NAME TYPE FROM USERS U
...
CREATE PROCEDURE RET_VISIBLE_ORDER_USER_PR
	@P_ID int
as
	Select US.NAME BUYER,L.NAME RESTAURANT,D.NAME DRIVER,DIR.COORDINATE_X LATITUDE, DIR.COORDINATE_Y LONGITUDE,U.Name STATUS,O.Start_Time START_TIME from orders O
	Join UTILS U on O.STATUS=U.Id
