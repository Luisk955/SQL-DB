...
AS
	...
	INSERT INTO MEMBERSHIP (id,fee,type,COMMISSION,FEE_INTERVAL,STATUS) VALUES (@P_ID,@P_FEE,@P_TYPE,@P_COMMISSION,@P_FEE_INTERVAL,@P_STATUS);
...
AS
	...
	VALUES (@P_ID,@P_NAME,@P_LAST_NAME,@P_PHONE_NUMBER,@P_BIRTHDATE,@P_PASSWORD,@P_STATUS, @P_BALANCE,@P_PAYPAL_USER,@P_EMAIL,@P_CREATION_DATE,@P_PHONE_CONF,@P_EMAIL_CONF);
